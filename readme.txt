=== Most Popular Pages ===
Contributors: Mohammed Khan
Tags: Google Analytics

A WordPress plugin that uses Google Analytics to display your most popular pages from the last 30 days.

== Description ==
This is an *untested* first draft (unfortunately) plugin for WordPress which generates a page for your viewers containing
...
your top 10 pages from the last 30 days ordered by number of views. **NB** You will end up with an error message if trying to
...
4. Input your Analytics settings, to find your settings visit https://console.developers.google.com/ you can also take a look at https://developers.google.com/analytics/solutions/articles/hello-analytics-api#register_project to understand what's going and maybe even do some troubleshooting.
5. That should hopefully do it. Click the link to see the results.
